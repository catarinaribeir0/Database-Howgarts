...
CREATE TABLE `terreno` (
  ...
  PRIMARY KEY (`idInst`),
  CONSTRAINT `terreno_ibfk_1` FOREIGN KEY (`idInst`) REFERENCES `instalacao` (`idInst`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `terreno` VALUES (1),(2),(3),(4),(5),(6),(7),(8);
